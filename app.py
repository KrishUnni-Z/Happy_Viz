...
def set_background():
    st.markdown(
        ...
        <style>
        .stApp {{
            background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXFfljod8DEZw3_aVpkIeOjPOWMhQEfv8phA&s");
        ...
        .stApp::before {{
            ...
            width: 100vw;
            height: 100vh;
            background-color: rgba(255, 255, 255, 0.25);  /* Light overlay with alpha */
            z-index: 0;
        }}
